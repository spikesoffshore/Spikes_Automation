...
public class Google_LocalToRACCopyMouseRightClickPaste extends testCases.Base {
	
	private WebDriver driver;
	private String currentSitePath;
	ExtentTest parentTest = ReportGenerator.initializeParentTest(getClass().getName().substring(10),"Testing Local to RAC Copy Paste for Google using Mouse Right Click");
	...
	public void executeScript(){
		...
		try{
			...
			SikuliUtil.mouseRightClick("SearchBox", screen);
			Sleep(300);
			
			//Right click mouse paste option
