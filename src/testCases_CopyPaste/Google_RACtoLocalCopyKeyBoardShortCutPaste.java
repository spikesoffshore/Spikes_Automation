...
public class Google_RACtoLocalCopyKeyBoardShortCutPaste extends testCases.Base {
	
	private WebDriver driver;
	private String currentSitePath;
	ExtentTest parentTest = ReportGenerator.initializeParentTest(getClass().getName().substring(10),"Testing RAC to Local Copy Paste for Google using KeyBoard shortCut");
	...
	public void executeScript(){
		...
		ReportGenerator.logStatusPass(parentTest, testCaseName, "RAC to Local Copy Paste for Google using Keyboard shortcut testcase is working as expected");
		...
		ReportGenerator.logStatusFail(parentTest,testCaseName, "RAC to Local Copy Paste for Google using keyboard shortcut testcase Failed,Please see logs and error screenshots", this.driver);
	}
		finally{
