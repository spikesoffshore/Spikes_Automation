...
public class EbayCoUk extends Base {
	private WebDriver driver;
	private String currentSitePath;
	private String testCaseName=getClass().getName().substring(10); 
	ExtentTest parentTest = ReportGenerator.initializeParentTest(getClass().getName().substring(10),"Testing Ebay.Co.Uk");
		...
		public void navigateToURL(WebDriver driver){
			...
			try{
				...
				SikuliUtil.verifyObjectAndHighlight("Ebay_favicon", screen, parentTest,"Verify ebay.co.uk favicon",driver,testCaseName,"Yes");
				
				SikuliUtil.verifyObjectAndHighlight("EbayLogo", screen, parentTest,"ebay.co.uk Home Logo",driver,testCaseName,"No");
				...
				SikuliUtil.verifyObjectAndHighlight("Ebay_favicon", screen, parentTest,"Verify ebay.co.uk favicon",driver,testCaseName,"No");
				...
				siteURL="http://www.ebay.co.uk/itm/192078659759";
				driver.navigate().to(baseurl+siteURL);
